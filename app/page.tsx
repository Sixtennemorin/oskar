...
export default function Home() {
  ...
  return <>
    ...
    <footer className="bg-black px-7 pb-24 pt-10 text-stone-300 lg:px-10 lg:pb-10"><div className="mx-auto flex max-w-[1320px] flex-col justify-between gap-8 text-sm sm:flex-row sm:items-end"><div className="h-14 w-44 overflow-hidden"><Image src="/images/oskar-bilvard-logo.png" alt="Oskar Bilvård" width={1777} height={888} className="h-full w-full scale-[1.62] object-cover invert" /></div><div className="sm:text-center"><a className="block hover:text-white" href={company.facebook} target="_blank" rel="noreferrer">Facebook</a><a className="mt-2 block hover:text-white" href={`mailto:${company.email}`}>{company.email}</a></div><p className="text-stone-400">© {new Date().getFullYear()} Oskar Bilvård</p></div></footer>
